...
const TransactionTable = ({ transactions, onEdit, onDelete, isLoading }) => {
  ...
  if (transactions.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-12 text-center">
        ...
        <p className="text-gray-500">Add your first transaction to start tracking your finances</p>
      </div>
    );
  }
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {transactions.map((transaction) => (
              <>
                ...
                {expandedRow === transaction.id && transaction.category_source && transaction.category_source !== 'default' && (
                    ...
                    <td colSpan="9" className="px-6 py-4">
                      <div className="text-sm">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-gray-600">
                          ...
                          <div>
                            <span className="font-medium">Source:</span> {transaction.category_source === 'rule' ? 'Automatic Rule' : transaction.category_source === 'manual' ? 'Manual' : transaction.category_source}
                          </div>
                          <div>
